...
public class StringLengthGreaterThanOrEqualToRuleTest extends AbstractStringLengthRuleTest {
    ...
    public static List<Object[]> getTestData() {
        Object[][] data = new Object[][] {
                ...
                new Object[] { "012345",        5,      false, true},
                new Object[] { "01234 ",        5,      true,  true},
                new Object[] { " 01234",        5,      true,  true},
                new Object[] { " 01234 ",       5,      true,  true},
                new Object[] { " 01234 ",       5,      false, true},
    ...
    protected AbstractStringBooleanRule createStringLengthRule() {
        StringLengthGreaterThanOrEqualToRule stringLengthGreaterThanOrEqualToRule = new StringLengthGreaterThanOrEqualToRule(length);
